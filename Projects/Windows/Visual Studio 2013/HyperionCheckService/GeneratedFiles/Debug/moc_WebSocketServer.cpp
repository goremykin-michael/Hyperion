...
#include "../../../../../../Source/HyperionCheckService/Server/WebSocketServer.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_WebSocketServer_t, stringdata) + ofs \
...
void WebSocketServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (WebSocketServer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WebSocketServer::closed)) {
                *result = 0;
            }
        }
    }
...
void *WebSocketServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_WebSocketServer.stringdata))
